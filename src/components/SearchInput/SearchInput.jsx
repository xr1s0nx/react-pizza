...
const SearchInput = () => {
   ...
   const {searchVal, changeSearchVal} = React.useContext(searchContext);
   ...
   return (
      <div className={classes.inputBlock}>
         ...
         />
         {searchVal ? (
            <svg onClick={() => changeSearchVal('')} className={classes.iconD} fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px">
