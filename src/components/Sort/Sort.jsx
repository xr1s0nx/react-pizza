...
import { changeSort, toggleAsc, togglePopUpVisibility } from "../../redux/slices/filterSlice";
   ...
   return (
      <div className="sort">
         <div className="sort__label">
            <svg className={ascStatus ? '' : 'rotate'} onClick={() => {dispatch(toggleAsc())}} width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path
